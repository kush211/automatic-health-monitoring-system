...
export default function LoginPage() {
  ...
  return (
    <div className="w-full lg:grid lg:min-h-screen lg:grid-cols-2 xl:min-h-screen font-body">
      <div className="relative hidden h-full w-full bg-gray-900 text-white lg:block">
        ...
        <div className="absolute bottom-8 left-8">
            <div className="max-w-md">
                ...
                <p className="mt-4 text-sm font-semibold text-white">- Dr. Priya Sharma</p>
            </div>
        </div>
      </div>
